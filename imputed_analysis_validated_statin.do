log using imputed_analysis_validated.log, replace
...
drop if statin_otc==1
drop if statin_end_prescribing==1
replace baseline_receiver_3month = 0 if baseline_receiver_3month==. & statin==0 & statin_primary==0
drop if baseline_receiver_3month==.
rename statin statin_reported
rename baseline_receiver_3month statin
...
foreach exp in eduyears qrisk_score  {
	...
	putexcel set 202003_imputed_validated, sheet(`exp'-`out') modify
...
foreach out in qrisk_score statin statin_type {
	...
	putexcel set 202003_imputed_validated, sheet(eduyears-`out') modify
...
foreach out in statin statin_type {
	...
	putexcel set 202003_imputed_validated, sheet(qrisk_score-`out') modify	
