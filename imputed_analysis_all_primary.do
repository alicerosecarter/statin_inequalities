log using imputed_analysis_all_primary.log, replace
...
foreach exp in eduyears qrisk_score  {
	...
	putexcel set 202003_imputed_all_primary, sheet(`exp'-`out') modify
...
foreach out in qrisk_score statin statin_type {
	...
	putexcel set 202003_imputed_all_primary, sheet(eduyears-`out') modify
...
foreach out in statin statin_type {
	...
	putexcel set 202003_imputed_all_primary, sheet(qrisk_score-`out') modify	
